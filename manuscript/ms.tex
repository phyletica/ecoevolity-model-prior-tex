...
Rewrite Intro because it's kind of overlapping with the result section.

Phylogeographic Study \\
Sharing divergence time across taxa \\
Shared divergence across taxa happened via geological events. \\
Temporal clustering reveals evolutionary history of the taxa. \\
Temporal pattern- \\
Model the evolutionary process \\
Important to know the behavior of the models \\
Evolutionary events
