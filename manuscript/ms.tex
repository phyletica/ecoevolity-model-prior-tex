...
\begin{figure}[htbp]
    \begin{center}
        ...
        model. 
        The first row shows the mean distance from the true
        divergence model (\etimesets) of the posterior samples
        \citep{Kuhn1955,Munkres1957,Gusfield2002} calculated
        using Version 1.1.4 of the munkres Python package
        \citep{Clapper2020}.
